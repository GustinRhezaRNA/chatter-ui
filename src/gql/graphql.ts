...
export type GetChatsQuery = { __typename?: 'Query', chats: Array<{ __typename?: 'Chat', _id: string, name: string, latestMessage?: { __typename?: 'Message', _id: string, content: string, createdAt: any, chatId: string, user: { __typename?: 'User', _id: string, username: string, email: string } } | null }> };
